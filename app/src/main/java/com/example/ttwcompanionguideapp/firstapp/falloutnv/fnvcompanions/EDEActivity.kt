...
class EDEActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_edeactivity)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.ede)) { v, insets ->
