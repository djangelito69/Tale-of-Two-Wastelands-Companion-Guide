...
class PaladinCrossActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_paladin_cross)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.paladincross)) { v, insets ->
