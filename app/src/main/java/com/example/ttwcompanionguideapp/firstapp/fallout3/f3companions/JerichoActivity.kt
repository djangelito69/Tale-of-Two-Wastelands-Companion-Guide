...
class JerichoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_jericho)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.jericho)) { v, insets ->
